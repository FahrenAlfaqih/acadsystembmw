                ...
                <table class="w-full table-auto text-left border-separate border-spacing-0 mt-4">
                    ...
                    <tbody>
                        ...
                        <tr class="border-b hover:bg-gray-50 transition duration-300">
                            ...
                            <td class="py-3 px-4 text-sm">
                                <a href="{{ route('guru.show', $data->id) }}" class="inline-block text-sm text-blue-600 hover:underline">Detail</a>
                                <a href="{{ route('guru.edit', $data->id) }}" class="inline-block text-sm text-yellow-600 hover:underline">Edit</a>
                            </td>
                            @endif
                        </tr>
                        @endforeach
